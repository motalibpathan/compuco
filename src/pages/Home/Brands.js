  ...
  return (
    <div style={containerStyle}>
      <div className="mt-24 max-w-[1140px] mx-auto w-full">
        <h1 className="font-poppins text-center md:text-5xl text-2xl font-bold">
          People we've worked with
        </h1>
        <div className="grid md:grid-cols-6 grid-cols-2 justify-items-center items-center space-x-5 space-y-5 mb-10 mt-16">
          <img
            className="w-20"
        ...
        <div className="grid md:grid-cols-6 grid-cols-2  space-x-7 space-y-7 justify-items-center">
          <img
            className="w-32"
