  ...
  return (
    <>
      <div className="md:w-[1140px] mx-auto w-full">
        <div className="md:flex justify-center items-center md:py-10 py-2 md:my-10 my-0 px-5">
          <div className="md:w-3/5 w-full">
            ...
            <div className="text-gray-700 font-work space-y-7 mt-7 w-4/5">
              <p>
                We are a creative technology agency who specialise in working
                with social purpose organisations such as charities, membership
                organisations and grant giving foundations.
              </p>
              <p>
        ...
        <div>
          <h1 className="text-5xl font-bold text-center text-gray-900 text-poppins">
          ...
          <img
            ...
            alt=""
          />
          <p className="w-2/5 mx-auto text-center my-5 font-work text-gray-600">
            We specialise in working with Open Source technologies such as
            Drupal and CiviCRM, but we also like to work with a number of other
            frameworks and technologies.
          </p>
        </div>
        <div className="mt-10">
          {worksData.map((work) => (
            <ServiceCard key={work.id} work={work} />
          ))}
        </div>
      </div>
      <ServiceList />
