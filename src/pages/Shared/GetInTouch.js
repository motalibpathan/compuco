        ...
        <>
          ...
          >
            <div className=" max-w-[1140px] mx-auto w-full md:py-16 p-5">
              <div
                className={`md:flex md:mt-10 mt-5 text-center md:text-left  ${
                  isVisible ? "opacity-100" : "opacity-0"
              ...
              >
                ...
                <div className="md:w-3/5 w-full space-y-7 text-lg text-gray-700 font-work p-5">
                  <p className="">
                    If you have a project you'd like to share with us, or even
                    just a quick question, we'd love to hear from you. Get in
                    touch below!
                  </p>
                  <Link
                    to="/contact-us"
